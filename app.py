...
# Troque 'G-XXXXXXXXXX' pelo seu ID de rastreamento real do Google Analytics.
...
st.markdown("""
    <style>
        /* 1. Oculta os itens padrão do topo e do rodapé (A sua foto no canto inferior direito) */
        header { background-color: transparent !important; z-index: 999990 !important; }
        [data-testid="stToolbar"], .stAppDeployButton, .viewerBadge_container__1JCIV, .viewerBadge_link__1S137, footer { display: none !important; }
        
        /* 2. Botão Flutuante Escuro para o Menu (Garante que a setinha funcione) */
        ...
        /* 5. Caixas de Texto (Design Fluido e Bonito) */
