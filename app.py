...
# --- INJEÇÃO DE CSS (ESTÁVEL E SEM BUGAR O MENU) ---
st.markdown("""
    <style>
        /* 1. Oculta botões de sistema do Streamlit (Deploy, GitHub, Menu direito), mas DEIXA o botão do menu esquerdo em paz */
        header .stAppDeployButton { display: none !important; }
        [data-testid="stHeaderActionElements"] { display: none !important; }
        footer { visibility: hidden !important; }
        
        /* 2. Ajuste de margens do conteúdo principal */
        .block-container { padding-top: 2rem !important; max-width: 1050px; }
        [data-testid="stSidebar"] > div:first-child { padding-top: 0rem !important; }
        
        /* 3. Design da Barra Lateral (Cores profissionais estilo 4Devs) */
        ...
        /* 5. Inputs e Caixas de Texto da Ferramenta */
