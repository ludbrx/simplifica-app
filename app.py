...
# --- INJEÇÃO DE CÓDIGO NO <HEAD> PAI (ADSENSE, ANALYTICS E GESTOS TOUCH) ---
injections = """
<script>
  // 1. Google Analytics
  ...
  // 2. CÓDIGO DO ADSENSE (INSERIDO E CONFIRMADO)
  ...
  // 3. MÉTODO ARRASTAR/DESLIZAR (SWIPE GESTURE) PARA SMARTPHONES
  let touchstartX = 0;
  let touchstartY = 0;
  ...
  window.parent.document.addEventListener('touchend', function(e) {
      ...
      // Verifica se o movimento foi da esquerda para a direita (Swipe Right) e predominantemente horizontal
      if (touchendX - touchstartX > 60 && Math.abs(touchendY - touchstartY) < 40) {
          // Se o gesto começar próximo à borda esquerda (250px iniciais)
          if (touchstartX < 250) {
...
# --- INJEÇÃO DE CSS DE ALTA PERFORMANCE (MÉTODO ABA LATERAL FIXA) ---
st.markdown("""
    <style>
        /* Ocultar elementos inúteis de marca d'água */
        .stAppDeployButton, .viewerBadge_container__1JCIV, .viewerBadge_link__1S137, footer { display: none !important; }
        [data-testid="stToolbar"] { visibility: hidden !important; }
        
        /* Ajustes de espaçamento do corpo do site */
        .block-container { padding-top: 1.5rem !important; max-width: 1050px; }
        [data-testid="stSidebar"] > div:first-child { padding-top: 0rem !important; }
        
        /* TRANSFORMANDO O BOTÃO REEXIBIR EM UMA ABA FIXA INTUITIVA (PULL-TAB) */
        [data-testid="collapsedControl"] {
            display: flex !important;
            visibility: visible !important;
            opacity: 1 !important;
            
            /* Posicionamento Fixo na Borda Esquerda da Tela */
            ...
            /* Visual Moderno e Alinhado à UX */
            background-color: #3B82F6 !important; /* Azul Chamativo */
            box-shadow: 4px 0px 15px rgba(59, 130, 246, 0.4) !important;
        ...
        /* Efeito Hover na Aba Puxadora */
        [data-testid="collapsedControl"]:hover {
            width: 42px !important;
            background-color: #1D4ED8 !important;
        }
        
        /* Ajustando a Seta para apontar para dentro do site, indicando abertura */
        [data-testid="collapsedControl"] svg {
            fill: #FFFFFF !important;
            color: #FFFFFF !important;
            transform: scale(1.3) rotate(180deg) !important; /* Rotaciona a seta para ser um indicativo de puxar */
            width: 20px !important;
            height: 20px !important;
        }
        
        /* Adicionando um texto sutil de instrução flutuante via CSS na barra se necessário */
        ...
        [data-testid="collapsedControl"] svg { display: none !important; } /* Oculta o ícone nativo bugado e deixa nossa seta limpa */

        /* Design de Cores da Barra Lateral (Estilo 4Devs Profissional) */
        ...
        /* Inputs e Caixas de Configuração */
...
# Barra de Botões Institucionais
